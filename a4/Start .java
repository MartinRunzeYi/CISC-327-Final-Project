	...
	public static void main(String[] args) throws Exception{
		...
		while (true) {
			...
			while  ( !  (choice.equalsIgnoreCase("machine") || choice.equalsIgnoreCase("agent") )  ) {
				...
				BackOffice officeDemo = new BackOffice(args[2]);
				Frontend testDemo = new Frontend(args[0], args[1], choice,officeDemo);
				...
				officeDemo.mergeSummaryFile(testDemo.getSummary());
							
				officeDemo.writeMasterFile(testDemo.getAccount());
...
class BackOffice{
	...
	public void writeMasterFile(String accountFile) throws Exception{
		...
		Arrays.parallelSort(collectionNumber);
...
class Frontend {
	...
	public void setBack(BackOffice back){
		this.back = back;
	}
	
	public BackOffice getBack() {
		return this.back;
	}
	...
	*/
	...
	public Frontend(String accountFile,String summaryFile,String mode,BackOffice back){
	...
	*/
	...
	public void deleteAccount(){
		...
		int moneyBalance = this.back.checkBalance(Integer.parseInt(number));
		
		if (moneyBalance == 0) {
			
			if (this.back.checkName(Integer.parseInt(number)).equalsIgnoreCase(name)) {
				...
				System.out.println("Name is invalid, Delete Transaction Failed");
			}
		}
		else {
			System.out.println("Balance is not zero, Delete Transaction Failed");
		}
